...
{
    [SerializeField] private ManualNavigation manualNavigation;
    [Header("Enemy Settings")]
    [SerializeField] private GameObject kepitingPrefab;
    [SerializeField] private GameObject bintangPrefab;
    ...
    [Range(0f, 1f)]
    [SerializeField] private float kepitingProbability = 0.5f; // 0.5 = 50% chance for enemy1, 50% for enemy2
    ...
    void SpawnSingleEnemy()
    {
        ...
        spawnedEnemy.GetComponent<PatrolAI>().manualNavigation = this.manualNavigation;
        spawnedEnemy.GetComponent<PatrolAI>().StartPatrol();
    ...
    GameObject ChooseEnemyType()
    {
        ...
        if (randomValue <= kepitingProbability)
        {
            return kepitingPrefab;
        }
        else
        {
            return bintangPrefab;
        }
    }
    ...
    {
        kepitingProbability = Mathf.Clamp01(probability);
    }
